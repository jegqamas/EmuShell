...
void Mapper205::WriteSRM(uint16_t& address, uint8_t& value)
{
    switch (value & 0x3)
    {
    case 0:
...
void Mapper205::WritePRG(uint16_t& address, uint8_t& value)
{
...
void Mapper205::OnPPUA12RaisingEdge()
{
