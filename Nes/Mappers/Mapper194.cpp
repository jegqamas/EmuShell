...
void Mapper194::WritePRG(uint16_t& address, uint8_t& value)
{
...
void Mapper194::SetupCHR()
{
    if (!flag_c)
    {
        Switch02KCHR(chr_reg[0] > 1 ? (chr_reg[0] - 1) >> 1 : chr_reg[0] >> 1, 0x0000, chr_reg[0] > 1);
        Switch02KCHR(chr_reg[1] > 1 ? (chr_reg[1] - 1) >> 1 : chr_reg[1] >> 1, 0x0800, chr_reg[1] > 1);
        Switch01KCHR(chr_reg[2] > 1 ? (chr_reg[2] - 1) : chr_reg[2], 0x1000, chr_reg[2] > 1);
        Switch01KCHR(chr_reg[3] > 1 ? (chr_reg[3] - 1) : chr_reg[3], 0x1400, chr_reg[3] > 1);
        Switch01KCHR(chr_reg[4] > 1 ? (chr_reg[4] - 1) : chr_reg[4], 0x1800, chr_reg[4] > 1);
        Switch01KCHR(chr_reg[5] > 1 ? (chr_reg[5] - 1) : chr_reg[5], 0x1C00, chr_reg[5] > 1);
    }
    else
    {
        Switch02KCHR(chr_reg[0] >> 1, 0x1000, chr_reg[0] > 1);
        Switch02KCHR(chr_reg[1] >> 1, 0x1800, chr_reg[1] > 1);
        Switch01KCHR(chr_reg[2] > 1 ? (chr_reg[2] - 1) : chr_reg[2], 0x0000, chr_reg[2] > 1);
        Switch01KCHR(chr_reg[3] > 1 ? (chr_reg[3] - 1) : chr_reg[3], 0x0400, chr_reg[3] > 1);
        Switch01KCHR(chr_reg[4] > 1 ? (chr_reg[4] - 1) : chr_reg[4], 0x0800, chr_reg[4] > 1);
        Switch01KCHR(chr_reg[5] > 1 ? (chr_reg[5] - 1) : chr_reg[5], 0x0C00, chr_reg[5] > 1);
    }
}
void Mapper194::SetupPRG()
{
...
void Mapper194::OnPPUA12RaisingEdge()
{
