...
void Mapper024::InitializeSoundMixTable()
{
...
void Mapper024::WritePRG(uint16_t& address, uint8_t& value)
{
    switch (address)
    {
    case 0x8000:
...
void Mapper024::ClockExternalSoundChannelsSingle(bool& is_clocking_duration)
{
    pulse1->Clock();
    pulse2->Clock();
    sawtooth->Clock();
}
double Mapper024::GetExternalSoundChannelsOutput()
{
    return mix_table[pulse1->Output]
           [pulse2->Output]
           [sawtooth->Output];
}
void Mapper024::SaveState()
{
    Board::SaveState();
