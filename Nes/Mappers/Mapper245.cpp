...
void Mapper245::WritePRG(uint16_t& address, uint8_t& value)
{
    ...
    case 0x8001:
    {
        ...
        case 5:
            ...
            break;
        case 6:
            prg_reg[0] = value & 0x3F;
            SetupPRG();
            break;
        case 7:
            prg_reg[1] = value & 0x3F;
            SetupPRG();
            break;
        }
        break;
...
void Mapper245::SetupPRG()
{
    prg_or = (chr_reg[0] & 0x2) << 5;
    Switch08KPRG(prg_reg[flag_p ? 2 : 0] | prg_or, 0x8000, true);
    Switch08KPRG(prg_reg[1] | prg_or, 0xA000, true);
    Switch08KPRG(prg_reg[flag_p ? 0 : 2] | prg_or, 0xC000, true);
    Switch08KPRG(prg_reg[3] | prg_or, 0xE000, true);
}
void Mapper245::OnPPUA12RaisingEdge()
{
