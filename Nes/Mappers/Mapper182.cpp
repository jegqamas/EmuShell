...
void Mapper182::WritePRG(uint16_t& address, uint8_t& value)
{
    ...
    case 0xC000:// MMC3 $8001
    {
        ...
        case 3:
            ...
            break;
        case 4:
            prg_reg[0] = value & prg_08K_rom_mask;
            SetupPRG();
            break;
        case 5:
            prg_reg[1] = value & prg_08K_rom_mask;
            SetupPRG();
            break;
        case 6:
            chr_reg[2] = value;
...
void Mapper182::OnPPUA12RaisingEdge()
{
