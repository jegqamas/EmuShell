...
{
    this->Name = "X-in-1";
    this->MapperNumber = 160;
}
void Mapper160::HardReset()
{
    Board::HardReset();
...
void Mapper160::WriteEXP(uint16_t& address, uint8_t& value)
{
    switch (address)
    {
    case 0x5800:
...
void Mapper160::WriteSRM(uint16_t& address, uint8_t& value)
{
// NO SRAM !!
}
void Mapper160::WritePRG(uint16_t& address, uint8_t& value)
{
...
void Mapper160::WriteNMT(uint16_t& address, uint8_t& value)
{
    if (MAPPER90MODE)
    {
...
uint8_t Mapper160::ReadSRM(uint16_t& address)
{
    if (flag_s)
        return prg_banks[prg_indexes[0]][address & 0x1FFF];
    return 0;
}
uint8_t Mapper160::ReadEXP(uint16_t& address)
{
    switch (address)
    {
    case 0x5000:
...
uint8_t Mapper160::ReadNMT(uint16_t& address)
{
    if (MAPPER90MODE)
...
void Mapper160::OnPPUAddressUpdate(uint16_t& address)
{
    if (irqSource == 1)
    {
