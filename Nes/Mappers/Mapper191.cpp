...
void Mapper191::WritePRG(uint16_t& address, uint8_t& value)
{
...
void Mapper191::SetupCHR()
{
    if (!flag_c)
    {
        Switch02KCHR(chr_reg[0] >> 1, 0x0000, (chr_reg[0] & 0x80) == 0);
        Switch02KCHR(chr_reg[1] >> 1, 0x0800, (chr_reg[1] & 0x80) == 0);
        Switch01KCHR(chr_reg[2], 0x1000, (chr_reg[2] & 0x80) == 0);
        Switch01KCHR(chr_reg[3], 0x1400, (chr_reg[3] & 0x80) == 0);
        Switch01KCHR(chr_reg[4], 0x1800, (chr_reg[4] & 0x80) == 0);
        Switch01KCHR(chr_reg[5], 0x1C00, (chr_reg[5] & 0x80) == 0);
    }
    else
    {
        Switch02KCHR(chr_reg[0] >> 1, 0x1000, (chr_reg[0] & 0x80) == 0);
        Switch02KCHR(chr_reg[1] >> 1, 0x1800, (chr_reg[1] & 0x80) == 0);
        Switch01KCHR(chr_reg[2], 0x0000, (chr_reg[2] & 0x80) == 0);
        Switch01KCHR(chr_reg[3], 0x0400, (chr_reg[3] & 0x80) == 0);
        Switch01KCHR(chr_reg[4], 0x0800, (chr_reg[4] & 0x80) == 0);
        Switch01KCHR(chr_reg[5], 0x0C00, (chr_reg[5] & 0x80) == 0);
    }
}
void Mapper191::SetupPRG()
{
...
void Mapper191::OnPPUA12RaisingEdge()
{
