...
Mapper209::Mapper209()
{
    ...
    this->MapperNumber = 209;
}
void Mapper209::HardReset()
{
    Board::HardReset();
...
void Mapper209::WriteEXP(uint16_t& address, uint8_t& value)
{
    switch (address)
    {
    case 0x5800:
...
void Mapper209::WriteSRM(uint16_t& address, uint8_t& value)
{
// NO SRAM !!
}
void Mapper209::WritePRG(uint16_t& address, uint8_t& value)
{
...
void Mapper209::WriteNMT(uint16_t& address, uint8_t& value)
{
    if (MAPPER90MODE)
    {
...
uint8_t Mapper209::ReadSRM(uint16_t& address)
{
    if (flag_s)
        return prg_banks[prg_indexes[0]][address & 0x1FFF];
    return 0;
}
uint8_t Mapper209::ReadEXP(uint16_t& address)
{
    switch (address)
    {
    case 0x5000:
...
uint8_t Mapper209::ReadNMT(uint16_t& address)
{
    if (MAPPER90MODE)
...
void Mapper209::OnPPUAddressUpdate(uint16_t& address)
{
    if (irqSource == 1)
    {
