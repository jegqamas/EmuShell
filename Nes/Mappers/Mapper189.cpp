...
void Mapper189::WriteEXP(uint16_t& address, uint8_t& value)
{
    Switch32KPRG(((value & 0xF0) >> 4) | (value & 0xF), true);
}
void Mapper189::WriteSRM(uint16_t& address, uint8_t& value)
{
    Switch32KPRG(((value & 0xF0) >> 4) | (value & 0xF), true);
}
void Mapper189::WritePRG(uint16_t& address, uint8_t& value)
{
...
void Mapper189::OnPPUA12RaisingEdge()
{
