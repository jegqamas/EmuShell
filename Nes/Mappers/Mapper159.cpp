...
void Mapper159::WriteSRM(uint16_t& address, uint8_t& value)
{
    this->WritePRG(address, value);
}
uint8_t Mapper159::ReadSRM(uint16_t& address)
{
    return eprom->Read(address);
}
void Mapper159::WritePRG(uint16_t& address, uint8_t& value)
{
